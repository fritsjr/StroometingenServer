...
router.get('/', function(req, res, next) {
    ...
    var queryURL = "SELECT DATE_FORMAT(datum, '%Y-%m-%d') AS the_date, COUNT(*) AS count FROM meetwaarde where datum between date_sub(now(),INTERVAL 1 WEEK) and now() GROUP  BY the_date;";
